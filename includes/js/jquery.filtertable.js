...
(function($) {
    ...
    $.fn.filterTable = function(options) { // define the filterTable plugin
        ...
        var defaults = { // start off with some default settings
                ...
                containerClass:    null,                // class to apply to the container
                ...
                highlightClass:    null,                // class applied to cells containing the filter term
                ...
                inputName:         '#recherche',        // name of filter input field
                inputType:         'text',            // tag name of the filter input tag
                label:             '<div class="col-lg-2"><i class="fa fa-search"></i> Recherche :</div>',           // text to precede the filter input tag
